...
>
	...
	{#each slice.primary.item as {tech_color, tech_name}}
		<div class="flex items-center justify-center gap-4 mb-8 tech-row text-slate-700" aria-label={ tech_name || "undefined" }>
			{#each Array(15) as _, index}

				<span
					class="font-extrabold tracking-tighter uppercase tech-item text-8xl"
